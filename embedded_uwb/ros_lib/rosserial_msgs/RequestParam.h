...
static const char REQUESTPARAM[] = "rosserial_msgs/RequestParam";
  ...
  class RequestParamRequest : public ros::Msg
  {
    ...
    {
      int offset = 0;
      uint32_t length_name = RODOS::strlen(this->name);
      varToArr(outbuffer + offset, length_name);
      offset += 4;
      RODOS::memcpy(outbuffer + offset, this->name, length_name);
      offset += length_name;
      return offset;
    }
  ...
  class RequestParamResponse : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      *(outbuffer + offset + 3) = (this->strings_length >> (8 * 3)) & 0xFF;
      ...
      uint32_t length_stringsi = RODOS::strlen(this->strings[i]);
      varToArr(outbuffer + offset, length_stringsi);
      offset += 4;
      RODOS::memcpy(outbuffer + offset, this->strings[i], length_stringsi);
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      offset += sizeof(this->st_ints);
        RODOS::memcpy( &(this->ints[i]), &(this->st_ints), sizeof(int32_t));
      }
      ...
      offset += sizeof(this->st_floats);
        RODOS::memcpy( &(this->floats[i]), &(this->st_floats), sizeof(float));
      }
      ...
      offset += length_st_strings;
        RODOS::memcpy( &(this->strings[i]), &(this->st_strings), sizeof(char*));
      }
     return offset;
    }
