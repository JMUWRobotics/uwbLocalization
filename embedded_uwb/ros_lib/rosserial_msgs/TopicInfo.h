  ...
  class TopicInfo : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      *(outbuffer + offset + 1) = (this->topic_id >> (8 * 1)) & 0xFF;
      ...
      uint32_t length_topic_name = RODOS::strlen(this->topic_name);
      varToArr(outbuffer + offset, length_topic_name);
      offset += 4;
      RODOS::memcpy(outbuffer + offset, this->topic_name, length_topic_name);
      offset += length_topic_name;
      uint32_t length_message_type = RODOS::strlen(this->message_type);
      varToArr(outbuffer + offset, length_message_type);
      offset += 4;
      RODOS::memcpy(outbuffer + offset, this->message_type, length_message_type);
      offset += length_message_type;
      uint32_t length_md5sum = RODOS::strlen(this->md5sum);
      varToArr(outbuffer + offset, length_md5sum);
      offset += 4;
      RODOS::memcpy(outbuffer + offset, this->md5sum, length_md5sum);
