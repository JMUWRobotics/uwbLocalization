...
void uwb_write(uint8_t sourceId, uint8_t destId, uint8_t* msg, int sizeOfMsg, uint8_t mode /*= 0*/) {
    dwt_forcetrxoff(); // Force the transceiver off
    ...
    int x = dwt_starttx(mode); // Start transmission.
